package web.dr_docker_demo.dr_docker_module.webtestclasses;
...
import web.dr_docker_demo.dr_docker_module.webpageclasses.Screen1;
import web.dr_docker_demo.dr_docker_module.webpageclasses.Screen2;
...
String text1 = objScreen1.clkAContact_297661();
...
String text1 = objScreen2.clkABFS_297967();
		if(text1.equalsIgnoreCase(configFileObj.getProperty("BFS"+ i + datasetScreencount))){
			printSuccessLogAndReport(test, logger,  "Clicked on : " + configFileObj.getProperty("BFS"+ i + datasetScreencount));
			printSuccessLogAndReport(test, logger,  "Validated Link Text : " + configFileObj.getProperty("BFS"+ i + datasetScreencount));
		} else {
			printFailureLogAndReport(test, logger,  "Link Text is not displayed  : " + configFileObj.getProperty("BFS"+ i + datasetScreencount));
		}
